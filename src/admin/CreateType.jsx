      ...
      <div className="page-inner">
        <div className="d-flex align-items-left align-items-md-center flex-column flex-md-row pt-2 pb-4">
          ...
          <div className="ms-md-auto py-2 py-md-0">
            ...
            <a href="/type" className="btn btn-danger btn-round">Back To Style</a>
          </div>
        </div>
        <div>
        <div style={{padding:"30px", marginTop:"25px", width:"50%"}} className="mt-8 max-w-lg mx-auto bg-white p-6 rounded-lg shadow-lg">
      <h2 className="text-2xl font-semibold text-gray-800 mb-6 "> Add Style</h2>
      <form onSubmit={handleSubmit}>
        <div style={{display:"flex", justifyContent:"space-between", width:"60%"}}>
          <label style={{padding:"10px", marginTop:"10px"}}>Gender: </label>
          <input style={{height:"30px", marginTop:"15px"}} type="text" name="name" value={formData.name} onChange={handleInputChange} />
        </div>
        <div style={{display:"flex", justifyContent:"space-between", width:"60%"}}>
          <label style={{padding:"10px", marginTop:"10px"}}>Type: </label>
          <input style={{height:"30px", marginTop:"15px"}} type="text" name="description" value={formData.description} onChange={handleInputChange} />
        </div>
        <button type="submit"  className="px-4 py-2 bg-green-600  font-semibold rounded-md shadow-md hover:bg-green-700 focus:outline-none focus:ring-2 focus:ring-green-500" style={{backgroundColor:"green", color:"white", borderRadius:"7px", border:"none", marginTop:"30px"}}>Add Style</button>
      </form>
    </div>
        </div>
      </div>
