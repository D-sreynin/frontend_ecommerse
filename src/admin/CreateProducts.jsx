          ...
          <div className="page-inner">
            <div className="d-flex align-items-left align-items-md-center flex-column flex-md-row pt-2 pb-4">
              ...
              <div className="ms-md-auto py-2 py-md-0">
                ...
                <a href="/product" className="btn btn-danger btn-round">
                  Back To Product
                </a>
              </div>
            </div>
            <div>
              <div
                style={{ padding: "30px", marginTop: "25px", width: "50%" }}
              ...
              >
                ...
                <form onSubmit={handleSubmit}>
                  ...
                  <button
                    type="submit"
                    className="px-4 py-2 bg-green-600  font-semibold rounded-md shadow-md hover:bg-green-700 focus:outline-none focus:ring-2 focus:ring-green-500"
                    style={{
