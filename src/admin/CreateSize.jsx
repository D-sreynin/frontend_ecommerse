  ...
  <div className="main-panel">
    ...
    <div className="container">
      <div className="page-inner">
        <div className="d-flex align-items-left align-items-md-center flex-column flex-md-row pt-2 pb-4">
          ...
          <div className="ms-md-auto py-2 py-md-0">
            ...
            <a href="/size" className="btn btn-danger btn-round">Back To Size</a>
          </div>
        </div>
        <div>
      ...
      <form onSubmit={handleSubmit}>
        ...
        <div style={{display:"flex", justifyContent:"space-between", width:"60%"}}>
          <label style={{padding:"10px", marginTop:"10px"}}>Weight: </label>
          <input style={{height:"30px", marginTop:"15px"}} type="text" name="description" value={formData.description} onChange={handleInputChange} />
        </div>
        <button type="submit"  className="px-4 py-2 bg-green-600  font-semibold rounded-md shadow-md hover:bg-green-700 focus:outline-none focus:ring-2 focus:ring-green-500" style={{backgroundColor:"green", color:"white", borderRadius:"7px", border:"none", marginTop:"30px"}}>Add Size</button>
      </form>
    </div>
        </div>
      </div>
